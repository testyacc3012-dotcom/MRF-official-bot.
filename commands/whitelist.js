...
const { issueAppealInvite, unbanFromAppealServer } = require('../utils/appealInvites');
...
module.exports = {
  ...
  async execute(interaction) {
    ...
    // Unban from the appeal server first so they can actually use the new
    // invite — punishments ban them from the appeal server to prevent old
    // invites or lingering membership from being abused.
    await unbanFromAppealServer(interaction.client, target.id);
